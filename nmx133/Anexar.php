<?	include "mb_cab.php";
	...
	$sq3.="FROM (TS_Empresas E INNER JOIN ";
	$sq3.="TS_Admin A ON A.AdminId=E.AdminId) INNER JOIN ";
	$sq3.="TS_EmpresaPreguntas EP ON EP.EmpresaId=E.EmpresaId ";
	$sq3.="GROUP BY A.Nom,E.EmpresaId,E.Nom ";
	$sq3.="ORDER BY E.AdminId,E.Nom ";
	$rs3 =mysql_query($sq3,$link) or die("Error 9 : $sq3 ");
?>
			...
			<tr><td valign="top" align="center">
					...
					<?	$i=0;
						...
						while($row=mysql_fetch_object($rs3)){
							...
							$rs4=mysql_query($sq4,$link) or die("Error 36 : $sq4 ");
...
<?	}else{ ?>
						<td align="center"><? if($tpr>0){ ?><a href="Anexar_modificar.php?id=<?=$ide?>"><img border="0" src="img/btn_ver.png"></a><? } ?></td>
<?	} ?>
					</tr>
					<?	}
